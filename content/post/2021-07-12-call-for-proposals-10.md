...
Donc n'hésitez pas à proposer la vôtre, même si c'est votre première présentation. Les talks sont ouverts à tout type de niveaux et de thématiques SRE: principes, on-call, monitoring, best practices, incident management, post-mortem, outils, retours d'expérience, etc.

Pour envoyer vos propositions ou vos idées, vous pouvez nous contacter via Meetup.com ou envoyez directement votre proposition via Github en suivant [ce lien](https://github.com/sre-paris/meetups/issues/new?labels=proposal&template=new-proposal.md&title=Proposal%27s+title) et on les ajoutera au programme qui sera publié dans les jours à venir.
